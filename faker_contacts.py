...
def generate_contacts(num_contacts: int) -> list:
    """
    Генерує вказану кількість контактів з використанням Faker.

    Args:
        num_contacts (int): Кількість контактів, які потрібно згенерувати.

    Returns:
        list: Список згенерованих контактів.
    """
    contacts = []
    for _ in range(num_contacts):
        contact = {
